...
public class Common extends Application {
    ...
    public static final String BASICDETAILS = "basic_details";
    public static final String CONTACTDETAILS = "contact_details";
    public static final String ABOUTCOMPNAY = "about_company";
