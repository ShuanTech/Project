...
public class CompanyDetail extends AsyncTask<String, String, String> {
    ...
    public CompanyDetail(Context mContext, String u_id,String orgName, String type, String addr, String land, String city, String ste, String cntry, String pin, boolean ins) {
    ...
    protected void onPostExecute(String s) {
        ...
        if(s.equalsIgnoreCase("true")){
            ...
            mApp.getPreference().edit().putBoolean(Common.BASICDETAILS,true).commit();
            Intent in=new Intent(mContext, CompanyContactInfoActivity.class);
            in.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            mContext.startActivity(in);
            ((AppCompatActivity)mContext).finish();
            new Follower(mContext,mApp.getPreference().getString(Common.u_id,"")).execute();
        }else{
