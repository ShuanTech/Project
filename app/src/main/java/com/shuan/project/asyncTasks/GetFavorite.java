...
public class GetFavorite extends AsyncTask<String,String,String> {
    ...
    public GetFavorite(Context mContext, ListView listView, ProgressBar progressBar,String id) {
    ...
    protected void onPostExecute(String s) {
        ...
        if(s.equalsIgnoreCase("true")){
            ...
            Toast.makeText(mContext,"No favourite yet",Toast.LENGTH_SHORT).show();
        }
